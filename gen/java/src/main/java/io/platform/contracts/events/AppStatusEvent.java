 ...
 */
@JsonPropertyOrder({
  AppStatusEvent.JSON_PROPERTY_TYPE,
  AppStatusEvent.JSON_PROPERTY_TIMESTAMP,
...
public class AppStatusEvent {
  ...
  public enum TypeEnum {
    APP_STATUS(String.valueOf("app.status"));
  ...
  @jakarta.annotation.Nonnull
  private AppStatusPayload payload;
  ...
  public AppStatusEvent type(@jakarta.annotation.Nonnull TypeEnum type) {
  ...
  public AppStatusEvent timestamp(@jakarta.annotation.Nonnull OffsetDateTime timestamp) {
  ...
  public AppStatusEvent payload(@jakarta.annotation.Nonnull AppStatusPayload payload) {
  ...
  public AppStatusPayload getPayload() {
    return payload;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_PAYLOAD, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setPayload(@jakarta.annotation.Nonnull AppStatusPayload payload) {
    this.payload = payload;
  }

  public AppStatusEvent origin(@jakarta.annotation.Nullable Origin origin) {
  ...
  public boolean equals(Object o) {
    ...
    AppStatusEvent appStatusEvent = (AppStatusEvent) o;
    return Objects.equals(this.type, appStatusEvent.type) &&
        Objects.equals(this.timestamp, appStatusEvent.timestamp) &&
        Objects.equals(this.payload, appStatusEvent.payload) &&
        Objects.equals(this.origin, appStatusEvent.origin);
  }
  ...
  public String toString() {
    ...
    sb.append("class AppStatusEvent {\n");
